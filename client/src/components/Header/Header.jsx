            ...
            <ul className={styles.menuContainer}>
              <li className={styles.menu}>
                ...
                >
                  ...
                  <span className={styles.text}>국내 종합 현황</span>
                </NavLink>
              </li>
              <li className={styles.menu}>
                <NavLink
                ...
                >
                  ...
                  <span className={styles.text}>시도별 현황</span>
                </NavLink>
              </li>
            </ul>
          </li>
            ...
            <ul className={styles.menuContainer}>
              <li className={styles.menu}>
                ...
                >
                  ...
                  <span className={styles.text}>해외 종합 현황</span>
                </NavLink>
              </li>
              <li className={styles.menu}>
                <NavLink
                ...
                >
                  ...
                  <span className={styles.text}>주변 국가별 현황</span>
                </NavLink>
              </li>
              <li className={styles.menu}>
                <NavLink
                ...
                >
                  ...
                  <span className={styles.text}>전 세계 대시보드</span>
                </NavLink>
              </li>
            </ul>
          </li>
            ...
            <ul className={styles.menuContainer}>
              <li className={styles.menu}>
                ...
                >
                  ...
                  <span className={styles.text}>코로나19 정보</span>
                </NavLink>
              </li>
              <li className={styles.menu}>
                <NavLink
                ...
                >
                  ...
                  <span className={styles.text}>주요 뉴스</span>
                </NavLink>
              </li>
            </ul>
          </li>
            ...
            <ul className={styles.menuContainer}>
              <li className={styles.menu}>
                ...
                >
                  ...
                  <span className={styles.text}>데이터 출처</span>
                </NavLink>
              </li>
            </ul>
          </li>
